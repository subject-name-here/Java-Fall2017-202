...
import ru.spbau.mit.java.paradov.ftp.NotEnoughArgumentsException;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/SettingsLayout.fxml"));
        primaryStage.setTitle("FTP FtpGuiClient");
